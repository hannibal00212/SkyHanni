...
class ProfileSpecificStorage {
    ...
    class ChocolateFactoryStorage {
        ...
        class HotspotRabbitStorage(
            @field:Expose var skyblockYear: Int?
        ) {
            @Expose
    ...
    class CarnivalStorage {
        ...
        @Expose
        var carnivalShopProgress: MutableMap<String, Map<String, Int>> = HashMap() // shop name -> (item name, tier)
    }

    @Expose
    var stats: MutableMap<SkyblockStat, Double?> = HashMap(SkyblockStat.entries.size)
    ...
    class CakeData {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (ownedCakes != otherProp.ownedCakes) return false
            return missingCakes == otherProp.missingCakes
        }
    }
    ...
    class HoppityEventStats {
        ...
        class RabbitData {
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return this.hashCode() == otherProp.hashCode()
            }
        }
