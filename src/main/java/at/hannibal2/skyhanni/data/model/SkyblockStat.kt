...
enum class SkyblockStat(
    ...
    HEALTH("§c❤", " Health: §r§c❤(?<value>\\d+)(?: .*)?", " §c❤ Health §f(?<value>.*)"), // TODO get from action bar
    DEFENSE("§a❈", " Defense: §r§a❈(?<value>\\d+)(?: .*)?", " §a❈ Defense §f(?<value>.*)"), // TODO get from action bar
    STRENGTH("§c❁", " Strength: §r§c❁(?<value>\\d+)(?: .*)?", " §c❁ Strength §f(?<value>.*)"),
    INTELLIGENCE("§b✎", " Intelligence: §r§b✎(?<value>\\d+)(?: .*)?", " §b✎ Intelligence §f(?<value>.*)"), // TODO get from action bar
    CRIT_DAMAGE("§9☠", " Crit Damage: §r§9☠(?<value>\\d+)(?: .*)?", " §9☠ Crit Damage §f(?<value>.*)"),
    CRIT_CHANCE("§9☣", " Crit Chance: §r§9☣(?<value>\\d+)(?: .*)?", " §9☣ Crit Chance §f(?<value>.*)"),
    FEROCITY("§c⫽", " Ferocity: §r§c⫽(?<value>\\d+)(?: .*)?", " §c⫽ Ferocity §f(?<value>.*)"),
    BONUS_ATTACK_SPEED("§e⚔", " Attack Speed: §r§e⚔(?<value>\\d+)(?: .*)?", " §e⚔ Bonus Attack Speed §f(?<value>.*)"),
    ABILITY_DAMAGE("§c๑", " Ability Damage: §r§c๑(?<value>\\d+)(?: .*)?", " §c๑ Ability Damage §f(?<value>.*)"),
    HEALTH_REGEN("§c❣", " Health Regen: §r§c❣(?<value>\\d+)(?: .*)?", " §c❣ Health Regen §f(?<value>.*)"),
    VITALITY("§4♨", " Vitality: §r§4♨(?<value>\\d+)(?: .*)?", " §4♨ Vitality §f(?<value>.*)"),
    MENDING("§a☄", " Mending: §r§a☄(?<value>\\d+)(?: .*)?", " §a☄ Mending §f(?<value>.*)"),
    TRUE_DEFENSE("§7❂", " True Defense: §r§f❂(?<value>\\d+)(?: .*)?", " §f❂ True Defense §f(?<value>.*)"),
    SWING_RANGE("§eⓈ", " Swing Range: §r§eⓈ(?<value>\\d+)(?: .*)?", " §eⓈ Swing Range §f(?<value>.*)"),
    SPEED("§f✦", " Speed: §r§f✦(?<value>\\d+)(?: .*)?", " §f✦ Speed §f(?<value>.*)"), // TODO add the way sba did get it (be careful with 500+ Speed)
    SEA_CREATURE_CHANCE("§3α", " Sea Creature Chance: §r§3α(?<value>\\d+)(?: .*)?", " §3α Sea Creature Chance §f(?<value>.*)"),
    MAGIC_FIND("§b✯", " Magic Find: §r§b✯(?<value>\\d+)(?: .*)?", " §b✯ Magic Find §f(?<value>.*)"),
    PET_LUCK("§d♣", " Pet Luck: §r§d♣(?<value>\\d+)(?: .*)?", " §d♣ Pet Luck §f(?<value>.*)"),
    FISHING_SPEED("§b☂", " Fishing Speed: §r§b☂(?<value>\\d+)(?: .*)?", " §b☂ Fishing Speed §f(?<value>.*)"),
    DOUBLE_HOOK_CHANCE("§9⚓", " Double Hook Chance: §r§9⚓(?<value>\\d+)(?: .*)?", ""),
    BONUS_PEST_CHANCE("§2ൠ", " (?:§r§7§m)?Bonus Pest Chance: (?:§r§2)?ൠ(?<value>\\d+)(?: .*)?", " (?:§7§m|§2)ൠ Bonus Pest Chance (?:§f)?(?<value>.*)"),
    COMBAT_WISDOM("§3☯", " Combat Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Combat Wisdom §f(?<value>.*)"),
    MINING_WISDOM("§3☯", " Mining Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Mining Wisdom §f(?<value>.*)"),
    FARMING_WISDOM("§3☯", " Farming Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Farming Wisdom §f(?<value>.*)"),
    FORAGING_WISDOM("§3☯", " Foraging Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Foraging Wisdom §f(?<value>.*)"),
    FISHING_WISDOM("§3☯", " Fishing Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Fishing Wisdom §f(?<value>.*)"),
    ENCHANTING_WISDOM("§3☯", " Enchanting Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Enchanting Wisdom §f(?<value>.*)"),
    ALCHEMY_WISDOM("§3☯", " Alchemy Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Alchemy Wisdom §f(?<value>.*)"),
    CARPENTRY_WISDOM("§3☯", " Carpentry Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Carpentry Wisdom §f(?<value>.*)"),
    RUNECRAFTING_WISDOM("§3☯", " Runecrafting Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Runecrafting Wisdom §f(?<value>.*)"),
    SOCIAL_WISDOM("§3☯", " Social Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Social Wisdom §f(?<value>.*)"),
    TAMING_WISDOM("§3☯", " Taming Wisdom: §r§3☯(?<value>\\d+)(?: .*)?", " §3☯ Taming Wisdom §f(?<value>.*)"),
    MINING_SPEED("§6⸕", " Mining Speed: §r§6⸕(?<value>\\d+)(?: .*)?", " §6⸕ Mining Speed §f(?<value>.*)"),
    BREAKING_POWER("§2Ⓟ", "", " §2Ⓟ Breaking Power §f(?<value>.*)"),
    PRISTINE("§5✧", " Pristine: §r§5✧(?<value>\\d+)(?: .*)?", " §5✧ Pristine §f(?<value>.*)"),
    FORAGING_FORTUNE("§☘", " Foraging Fortune: §r§6☘(?<value>\\d+)(?: .*)?", " §6☘ Foraging Fortune §f(?<value>.*)"),
    FARMING_FORTUNE("§6☘", " (?:§r§7§m)?Farming Fortune: (?:§r§6)?☘(?<value>\\d+)(?: .*)?", " (?:§7§m|§6)☘ Farming Fortune (?:§f)?(?<value>.*)"),
    MINING_FORTUNE("§6☘", " Mining Fortune: §r§6☘(?<value>\\d+)(?: .*)?", " §6☘ Mining Fortune §f(?<value>.*)"),
    FEAR("§5☠", " Fear: §r§5☠(?<value>\\d+)(?: .*)?", " §5☠ Fear §f(?<value>.*)"),
    ...
    MINING_SPREAD("§e▚", " (§r§7§m)?Mining Spread: (§r§e)?▚(?<value>\\d+)(?: .*)?", " (§7§m|§e)▚ Mining Spread (§f)?(?<value>.*)"),
    GEMSTONE_SPREAD("§e▚", " (§r§7§m)?Mining Spread: (§r§e)?▚(?<value>\\d+)(?: .*)?", " (§7§m|§e)▚ Gemstone Spread (§f)?(?<value>.*)"),
    ORE_FORTUNE("§6☘", " Ore Fortune: §r§6☘(?<value>\\d+)(?: .*)?", " §6☘ Ore Fortune §f103"),
    DWARVEN_METAL_FORTUNE("§6☘", " Dwarven Metal Fortune: §r§6☘(?<value>\\d+)(?: .*)?", " §6☘ Dwarven Metal Fortune §f(?<value>.*)"),
    BLOCK_FORTUNE("§6☘", " Block Fortune: §r§6☘(?<value>\\d+)(?: .*)?", " §6☘ Block Fortune §f(?<value>.*)"),
    GEMSTONE_FORTUNE("§6☘", " Gemstone Fortune: §r§6☘(?<value>\\d+)(?: .*)?", " §6☘ Gemstone Fortune §f(?<value>.*)"),
    HEAT_RESISTANCE("§c♨", " Heat Resistance: §r§c♨(?<value>\\d+)(?: .*)?", " §c♨ Heat Resistance §f(?<value>.*)"),
