...
class DropTypeManager {
    private val amountsLeft = mutableMapOf<DropType, Int>()

    init {
        DropType.entries.forEach { dropType ->
            amountsLeft[dropType] = when (dropType) {
                DropType.MANGO -> 10
                DropType.APPLE -> 8
                DropType.WATERMELON -> 4
                DropType.POMEGRANATE -> 4
                DropType.COCONUT -> 3
                DropType.CHERRY -> 2
                DropType.DURIAN -> 2
                DropType.DRAGONFRUIT -> 1
                DropType.RUM -> 5
                DropType.BOMB -> 15
                DropType.NOT_BOMB -> 34
                DropType.NONE -> 0
            }
        }
    }
...
enum class DropType(
    ...
    POMEGRANATE(200, "" +
        "http://textures.minecraft.net/texture/40824d18079042d5769f264f44394b95b9b99ce689688cc10c9eec3f882ccc08", "§9Pomegranate"),
    COCONUT(200,
    ...
    BOMB(0,
        "http://textures.minecraft.net/texture/a76a2811d1e176a07b6d0a657b910f134896ce30850f6e80c7c83732d85381ea", "§${config.mineText.chatColorCode}Bomb"),
